...
const IconWA = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" flexShrink="0">
...
export default function FloatingCTA() {
  ...
  const href = phone ? whatsappHref(phone, lang) : '#contact'
  ...
  return (
    <a
      ...
      aria-label={t("Let's Talk", "خلّنا نتواصل")}
      tabIndex={show ? 0 : -1}
    >
      <IconWA />
      <span className={styles.label}>{t(site.nav.cta.label, site.nav.cta.labelAr)}</span>
    </a>
  )
}
